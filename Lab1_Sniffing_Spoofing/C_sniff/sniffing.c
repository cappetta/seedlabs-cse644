// reference : http://www.airsupplylab.com/87-lab/ubuntu-linux-lab/257-seed-lab-02-writing-programs-to-sniff-packets.html
// code stripping tool: http://www.zubrag.com/tools/html-tags-stripper.php
...
int main()
{
    ...
    char        filter_exp[] = "proto \\TCP and (host 192.168.1.43 and 192.168.1.40) and dst portrange 20-100";   // filter expression
    bpf_u_int32 net;                                // IP
